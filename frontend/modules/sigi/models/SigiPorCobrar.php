...
class SigiPorCobrar extends \common\models\base\modelBase
{
    ...
    {
        return [
            [['codocu', 'edificio_id',  'monto',
                'cargoedificio_id',   'glosa', 'fechadoc',
                'codmon','fechaprog'], 'required'],
            // [['codocu','glosa','fechadoc','fechaprog','monto','edificio_id'], 'required'],
