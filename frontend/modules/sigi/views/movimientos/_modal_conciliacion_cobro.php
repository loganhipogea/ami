...
<div class="box box-success">
      ...
      <div class="box-header">
        ...
        <div class="col-md-12">
          ...
          <?php if($model->isNewRecord){
              $url= \yii\helpers\Url::to(['/sigi/'.$this->context->id.'/crea-conc-doc-inpu','id'=>$id]);
          }else{
             $url= \yii\helpers\Url::to(['/sigi/'.$this->context->id.'/edit-conc-doc-inpu','id'=>$id]); 
          } ?>
 ...
 /* echo selectSimpleWidget::widget([
         ...
         'addCampos'=>[4,5,8],
            ...
            dropDownList(\frontend\modules\sigi\helpers\comboHelper::getCboDocsPagados($model->edificio_id,'1'),
