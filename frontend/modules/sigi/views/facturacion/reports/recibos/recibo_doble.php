   ...
   <div style="position:absolute;
        ...
        <div style="position:absolute; padding:1px;border-style:none;top:5px; left:5px; ">
            <div style="float:right">
                <?=Html::img('@web/sigi/logo_diar.jpg',['width'=>85,'height'=>85])?>
            </div>

        </div>
    </div>

<div style=" position:absolute;  left:390px;  top:29px;  font-size:9;  font-family:cour;  color:#000; ">
    Fecha :
</div>
 <div style=" position:absolute;  left:481px;  top:29px;  font-size:9;  font-family:cour;  font-weight:bold;  color:#000; ">
       <?=$model->fecha?>
</div>
  <div style=" position:absolute; width:380px;
       left:269px;  top:665px; 
       font-size:9;  font-family:cour;
       font-weight:none;  color:#000; text-align:justify ">
   <?=$model->detalles?>
 </div>
 <div style="position:absolute;  left:85px;  top:36px;  font-size:9;  font-family:cour;  font-weight:bold;  color:#000; ">
    <?=$model->edificio->nombre?>
 </div>
 <div style="position:absolute;   left:85px;  top:50px;  font-size:6;  font-family:arial;  font-weight:none;  color:#000; ">
      <?=$model->edificio->direccion?>
 </div>
 <div style=" position:absolute;  left:36px;  top:76px;  font-size:14;  font-family:arial;  font-weight:bold;  color:#F72; ">
     <?php  
     if(!$detalle->resumido){
 ...
 <div style=" position:absolute;  left:36px;  top:665px;  font-size:6;  font-family:arial;  font-weight:bold;  color:#000; ">
   <?php
     if(!$detalle->resumido){     
    ...
    <div>
      <div style="width: 212px;">
       ...
       <div style=" position:absolute;  left:254px;  top:11px;  font-size:10.5;  font-family:cour;  color:#000; ">Recibo N° :<?=$detalle->numerorecibo?></div>

       <div style=" position:absolute;  left:390px;  top:40px;  font-size:9;  font-family:cour;  color:#000; ">F Vencimiento :</div>
       <div style=" position:absolute;  left:481px;  top:40px;  font-size:9;  font-family:cour;  font-weight:bold;  color:#000; "><?=$model->fvencimiento?></div>
       
       
       <div style=" position:absolute;  left:36px;  top:107px;  font-size:6;  font-family:arial;  font-weight:bold;  color:#000; ">
            <div>
       ...
       <div style=" position:absolute;  left:390px;  top:50px;  font-size:9;  font-family:cour;  color:#000; ">Dias facturados :</div>
       <div style=" position:absolute;  left:481px;  top:50px;  font-size:9;  font-family:cour;  font-weight:none;  color:#000; "><?=$detalle->dias?></div>
       ...
       <div style="position:absolute; width:90%; left:35px; top:141px">
