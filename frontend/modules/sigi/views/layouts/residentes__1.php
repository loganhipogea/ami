...
?>
  ...
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge" />
          <?= Html::csrfMetaTags() ?>
    <link rel="stylesheet" href="/frontend/web/css/residentes/light_tema/all.min.css" />
   <link rel="stylesheet" href="/frontend/web/css/residentes/light_tema/slick.css">
   <link rel="stylesheet" href="/frontend/web/css/residentes/light_tema/slick-theme.css">
  <link rel="stylesheet" href="/frontend/web/css/residentes/light_tema/magnific-popup.css">
    <link rel="stylesheet" href="/frontend/web/css/residentes/light_tema/bootstrap-min.css" />
    <link rel="stylesheet" href="/frontend/web/css/residentes/light_tema/tooplate-infinite-loop.css" />
      <?php $this->registerCssFile("@web/css/residentes/light_tema/all.min.css"); ?>
     <?php $this->registerCssFile("@web/css/residentes/light_tema/slick.css"); ?>
      <?php $this->registerCssFile("@web/css/residentes/light_tema/slick-theme.css"); ?>
     <?php $this->registerCssFile("@web/css/residentes/light_tema/magnific-popup.css"); ?>
       <?php $this->registerCssFile("@web/css/residentes/light_tema/bootstrap.min.css"); ?>
      <?php $this->registerCssFile("@web/css/residentes/light_tema/tooplate-infinite-loop.css"); ?>
         
 <?php $this->registerjsFile("@web/js/residentes/light_tema/jquery-1.9.1.min.js",['position'=>View::POS_END]); ?>
  <?php $this->registerjsFile("@web/js/residentes/light_tema/slick.min.js",['position'=>View::POS_END]); ?>
  <?php $this->registerjsFile("@web/js/residentes/light_tema/jquery.magnific-popup.min.js",['position'=>View::POS_END]); ?>
   <?php $this->registerjsFile("@web/js/residentes/light_tema/easing.min.js",['position'=>View::POS_END]); ?>
   <?php $this->registerjsFile("@web/js/residentes/jquery.singlePageNav.min.js",['position'=>View::POS_END]); ?>
  <?php $this->registerjsFile("@web/js/residentes/bootstrap.min.js",['position'=>View::POS_END]); ?>
