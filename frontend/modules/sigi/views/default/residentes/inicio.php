...
?>
    ...
    <!-- ===============================================-->
      ...
      <section class="py-0" id="home">
          <div class="bg-holder d-none d-md-block back-imagen" >
        </div>
        <!--/.bg-holder-->

        <div class="bg-holder d-block d-md-none back-imagen-otro">
        </div>
        <!--/.bg-holder-->
        ...
        <div class="container">
          <div class="row align-items-center min-vh-md-75 mt-7">
            <div class="col-md-7 col-lg-6 py-6 text-sm-start text-center">
              <h1 class="mt-6 mb-sm-4 display-4 fw-light lh-sm fs-4 fs-lg-6 fs-xxl-7">Bienvenido a nuestra plataforma <span class="text-primary">Diar gestión</span><br class="d-block d-lg-none d-xl-block" />  </h1>
              <p class="mb-5 fs-1 lh-lg">Permítanos ayudarle.</p>
              <a class="btn btn-lg btn-primary hover-top btn-glow btn-fijo" href="<?php echo Url::to(['default/resi-factu']);  ?>">Facturación
              ...
              <a class="btn btn-lg btn-primary hover-top btn-glow btn-fijo" href="#">Estado de deudas
                <svg class="bi bi-arrow-right-short ms-2" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" viewBox="0 0 16 16">
                  <path fill-rule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z"></path>
                </svg>
              </a>
              <a class="btn btn-lg btn-primary hover-top btn-glow btn-fijo" href="#">Consumo de agua
                <svg class="bi bi-arrow-right-short ms-2" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" viewBox="0 0 16 16">
                  <path fill-rule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z"></path>
                </svg>
              </a>
