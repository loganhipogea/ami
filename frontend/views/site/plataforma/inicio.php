...
<!--  <tr >
  ...
  <tr>
      <td  height="290" valign="top" style="background-color:#E3E3E3;width:1024px  !important;" >
           <div style="width:480px;height:250px;float:right;margin-right:20px;margin-top:20px;" >
               ...
               <div  style="width:480px; height:250px; float:left;margin-left:20px;margin-top:20px;"><table width='100%' border='0' cellspacing='0' cellpadding='0'><tr >
               <td height='250' valign='top'>
                               <table style="width: 100%;" border="0" cellspacing="0" cellpadding="0">
                                    <tbody>
                                            <tr>
