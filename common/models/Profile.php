...
class Profile extends \common\models\base\modelBase implements \common\interfaces\PersonInterface
{
   const SCENARIO_INTERLOCUTOR='tipo';
    const SCENARIO_PROPIETARIOS='propietarios';
    public $interlocutor='';
    /**
     * {@inheritdoc}
     */
    ...
    public function behaviors()
{
    ...
    public function rules()
    {
        return [
            ...
            [['user_id','codtra'], 'unique', 'targetAttribute' =>'codtra','except'=>self::SCENARIO_PROPIETARIOS ],
            ...
            [['tipo'],'safe','on'=>self::SCENARIO_INTERLOCUTOR],
             [['tipo'],'safe','on'=>self::SCENARIO_PROPIETARIOS],
    ...
    public function scenarios()
    {
        ...
        $scenarios[self::SCENARIO_INTERLOCUTOR] = ['tipo','codtra','user_id'];
         $scenarios[self::SCENARIO_PROPIETARIOS] = ['tipo','user_id'];
